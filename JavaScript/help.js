...
var but6 = document.getElementById("vvv6");
but6.addEventListener("click", function () {
    document.getElementById("head").innerHTML = "Change Your Account Settings";
    document.getElementById("para").innerHTML =
        "You can update your name, email address, password, or other account information."
    document.getElementById("head2").innerHTML = "Add and Manage Addresses";
    document.getElementById("para2").innerHTML =
...
var but7 = document.getElementById("vvv7");
but7.addEventListener("click", function () {
    document.getElementById("head").innerHTML = "Amazon.com Privacy Notice";
    document.getElementById("para").innerHTML = "Amazon Privacy Notice"
    document.getElementById("head2").innerHTML = "Conditions of Use";
    document.getElementById("para2").innerHTML = "."
    document.getElementById("div3").style.display = "none";
...
var but8 = document.getElementById("vvv8");
but8.addEventListener("click", function () {
    document.getElementById("head").innerHTML = "Payment Issues and Restrictions";
    document.getElementById("para").innerHTML =
        "."
    document.getElementById("head2").innerHTML = "Strike-through Pricing & Savings";
    document.getElementById("para2").innerHTML =
    ...
    document.getElementById("head3").innerHTML = "Unknown Charges ";
    document.getElementById("para3").innerHTML =
...
var but10 = document.getElementById("vvv10");
but10.addEventListener("click", function () {
    document.getElementById("head").innerHTML = "Site Features";
    document.getElementById("para").innerHTML = "."
    document.getElementById("head2").innerHTML = "Redeem a Gift Card";
    document.getElementById("para2").innerHTML = "."
    document.getElementById("div4").style.display = "block";
    document.getElementById("div3").style.display = "none";
    document.getElementById("head4").innerHTML = "Ordering"
